...
// End of functions internal to system.monitor.
/////////////////////////////////////////////////////////////////
...
void monitor_put(char c)
{
   ...
   if (c == 0x08 && cursor_x)	// Handle a backspace, by moving the cursor back one space
       cursor_x--;

   else if (c == 0x09)			// Handle a tab by increasing the cursor's X, but only to a point where it is divisible by 8.
...
void monitor_write_bin(uint32 x)
{
	int n;
