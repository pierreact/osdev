...
| Vector | IRQ | Device |
|--------|-----|--------|
| 0x20 | IRQ0 | Programmable Interrupt Timer |
| 0x21 | IRQ1 | Keyboard |
| 0x22 | IRQ2 | Cascade (internal, never raised) |
| 0x23 | IRQ3 | COM2 (if enabled) |
| 0x24 | IRQ4 | COM1 (if enabled) |
| 0x25 | IRQ5 | LPT2 (if enabled) |
| 0x26 | IRQ6 | Floppy Disk |
| 0x27 | IRQ7 | LPT1 / Spurious |
| 0x28 | IRQ8 | CMOS real-time clock (if enabled) |
| 0x29 | IRQ9 | Free for peripherals / legacy SCSI / NIC |
| 0x2A | IRQ10 | Free for peripherals / SCSI / NIC |
| 0x2B | IRQ11 | Free for peripherals / SCSI / NIC |
| 0x2C | IRQ12 | PS/2 Mouse |
| 0x2D | IRQ13 | FPU / Coprocessor / Inter-processor |
| 0x2E | IRQ14 | Primary ATA Hard Disk |
| 0x2F | IRQ15 | Secondary ATA Hard Disk |

## Software Interrupts

| Vector | Purpose |
|--------|---------|
| 0x4E | OS main software interrupt |
