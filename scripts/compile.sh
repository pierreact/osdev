...
# Log all compile output (stdout + stderr) to logs/compile.log
# while also showing it on the terminal.
exec > >(tee "$COMPILE_LOG") 2>&1
...
echo "[compile] Built raw image: $OBJ"
echo "[compile] Built BIOS ISO:  $ISO_IMAGE"
