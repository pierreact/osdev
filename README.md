...
**Researchers and prospective users:** you want to understand the project's goals, evaluate whether it fits your workload, or cite it.
- This file (`README.md`): research motivation, core concepts, evaluation goals.
- `doc/user/application-model.md`: the "Comparison with Linux for HPC" section at the end helps you decide if ZINC is a better fit than Linux for your use case.
- `glossary.md`: terminology reference.

**Application developers:** you want to write code that runs on ZINC.
- `doc/user/application-model.md`: execution model, memory model, device access, thread placement, fault tolerance, and how to design for this architecture.
- `hardware-compatibility.md`: hardware requirements (Intel processors, cache-coherent DMA).
- `glossary.md`: terminology reference.

**Kernel developers and contributors:** you want to understand internals, debug, or contribute.
- `ARCHITECTURE.md`: design decisions and rationale (memory allocation, execution model, device assignment, DSM, coherence protocol, fault tolerance).
- `memory_map.md`: physical memory layout.
- `DEBUG.md`: debugging procedures, GDB setup, QEMU monitor commands.
- `CHANGELOG.md`: history of changes.
- `doc/acpi.text`: ACPI table reference notes.
